...
const SectionHeader = ({ title, handlePrevSlickSlider, handleNextSlickSlider }) => {
  return (
    <div className=" border-b-[#F0F2F3] before:bg-[#634832] before:absolute before:top-[100%] before:left-0 before:h-[3px] before:w-[100px] before:content-[''] relative flex flex-row justify-between items-center pb-[26px] border-b-[3px]">
      ...
      <div className="flex flex-row gap-[10px]">
        <ArrowButton direction={"left"} handleSlickSlider={handlePrevSlickSlider} />
        <ArrowButton direction={"right"} handleSlickSlider={handleNextSlickSlider} />
      </div>
    </div>
  );
};
