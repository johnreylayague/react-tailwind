  ...
  return (
    <>
      {tabs
        ...
        .map((tab) => {
          return (
            <div key={tab.number} className="col-span-12 md:col-span-8 px-[15px]">
              <div className="border-[#F0F2F3] shadow-[0_3px_24px_rgba(0,0,0,.04)] bg-[#fff] sm:p-[40px] md:mt-0 mt-[30px] p-[20px] border">
